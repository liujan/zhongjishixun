...
public class MyImageProcessor  implements IImageProcessor {
	...
	public Image showChanelB(Image arg0) {
		...
		//过滤掉原图片的红色和绿色，并生成新图片
		Image image = Toolkit.getDefaultToolkit().createImage(new FilteredImageSource(arg0.getSource(), blueFilter));
		//图片宽度
	...
	public Image showChanelR(Image arg0) {
		...
		//过滤掉原图片的红色和蓝色，并生成新图片
		Image image = Toolkit.getDefaultToolkit().createImage(new FilteredImageSource(arg0.getSource(), redFilter));
		//宽度
		int width = image.getWidth(null);
		//高度
		int height = image.getHeight(null);
